...
return [
    ...
    'available_number_of_seats' => 'Количество мест не может быть меньше количества студентов, уже размещенных ' .
                                   'в данный момент времени.',
    'occupied_dorm_room' => 'В данной комнате не осталось свободных мест.',
    'telephone_format' => 'Номер телефона должен быть указан в формате: +7 (ХХХ) ХХХ-ХХ-XX',
    'latin_name_format' => 'Имя должно быть указано на латинском языке. Допустимы символы пробела и тире.',
    'cyrillic_name_format' => 'Имя должно быть указано на кириллице. Допустимы символы пробела и тире.',
    'extensions' => 'Файл, указанный в поле :attribute, должен иметь одно из следующих расширений: :values',
